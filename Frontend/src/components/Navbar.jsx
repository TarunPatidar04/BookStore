  ...
  return (
    <>
      <div className="max-w-screen-2xl container mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 z-50 dark:bg-slate-900 dark:text-white">
        <div
          className={`navbar dark:bg-slate-900 dark:text-white ${
            sticky
              ? "sticky shadow-md duration-300 bg-base-200 transition-all ease-in-out"
              : "bg-base-100"
          }`}
        >
          <div className="navbar-start dark:bg-slate-900 dark:text-white">
            ...
            <a className="text-2xl font-bold cursor-pointer">KitabKiDukan</a>
          </div>
          <div className="navbar-end space-x-3">
            ...
            <div className="hidden md:block">
              <label className="input  px-3 py-2 dark:bg-slate-900 dark:text-white border rounded-md flex items-center gap-2">
                <input
                  type="text"
